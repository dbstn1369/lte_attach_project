...
BOOL CPacketSenderDlg::Receive(u_char* ppayload)
{
	...
	case S1AP_MSG_TYPE_AUTHEN_REQUEST:// 받은 메시지 타입 (두 번째 과제)
		...
		m_S1AP->SetMessageType(S1AP_MSG_TYPE_AUTHEN_RESPONSE); // 보낼 메시지 타입
...
u_char* CPacketSenderDlg::attachReqItems() // (첫번째 과제)
{
	u_char temp[93] = {
		...
		// Item1 id-NAS-PDU
		///////////////////////////// Fill in the blank. ////////////////////////////////////////
		0x00,0x1a,0x00,0x35,0x34,0x17,0x7c,0x2a,0x01,0x33,0x06,0x07,0x41/* NAS EPS Mobility Management Message Type */,0x51,0x0b,0xf6
...
u_char* CPacketSenderDlg::authenticationRspItems()
{
	u_char temp[64] = {
		...
		0x00,0x08,0x00,0x02,0x00,0x00,
		//item2 id-NAS-PDU
		0x00,0x1a,0x00,0x12,0x11,0x17,0x38,0x6f,0x95,0x5b,0x08,0x07,0x00,0x08,0xaa,0x7a,
